				...
				<table>
					<?php
						try
						{
							...
							{
								echo "<tr><td>".$row[1]."</td><td><form></form><form action='delete_location.php' method='post'><button type='submit' name='delete' value='".$row[0]."'>刪除</button></form></td></tr>";
							}
							echo "</table>";
						}
...
EOT;
			...
			<form action='create_location.php' method='post'>
				<input type="text" name="location" placeholder="new location" value="">
